...
// Status: Pending
/*
Note: Given n residency with (x, y) coordinates with a state (0, 1). 1 means
there is electricity, 0 means no. Find the total shortest line of wire needed to
make sure all residency has electricity.
